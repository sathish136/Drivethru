...
export const leaveBalances = pgTable("leave_balances", {
  ...
  annualLeaveBalance: real("annual_leave_balance").notNull().default(0),
  casualLeaveBalance: real("casual_leave_balance").notNull().default(0),
  annualLeaveUsed: real("annual_leave_used").notNull().default(0),
  casualLeaveUsed: real("casual_leave_used").notNull().default(0),
