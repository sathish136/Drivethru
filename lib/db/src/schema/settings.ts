...
export const systemSettings = pgTable("system_settings", {
  ...
  organizationName: text("organization_name").notNull().default("Post Office"),
  organizationCode: text("organization_code").notNull().default("PO"),
...
export const holidays = pgTable("holidays", {
  ...
  type: text("type").notNull().$type<"national" | "religious" | "optional">().default("national"),
